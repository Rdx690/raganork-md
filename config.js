...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://files.catbox.moe/wqy1zl.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://files.catbox.moe/wqy1zl.jpeg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "◄⏤͟͞➸⃝❥͜͡𝑆𝛩𝑈𝑅𝛥𝐽𝛪𝑇➸⃝⚡",
    BOT_NAME: process.env.BOT_NAME || '◄⏤͟͞➸⃝❥͜͡𝑆𝛩𝑈𝑅𝛥𝐽𝛪𝑇➸⃝⚡',
